...
def MemoryAccess(flags=MEMORY_GET_NEW, *args):
    if _MemoryAccess._instance is None:
        _MemoryAccess._instance = _MemoryAccess( flags, *args)
...
_libsmbios_c.memory_obj_factory.errcheck = errorOnZeroFN()
...
_libsmbios_c.memory_obj_read.errcheck = errorOnNegativeFN()
...
_libsmbios_c.memory_obj_write.errcheck = errorOnNegativeFN()
